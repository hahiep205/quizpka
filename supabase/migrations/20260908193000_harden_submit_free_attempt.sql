-- Keep the client-reported attempt mirror idempotent and rate-limited.
-- Reapplies the function because 20260908190000 is already deployed.

drop index if exists public.practice_attempts_user_history_idx;
...
begin
  ...
  -- Serialize submissions per user so concurrent tabs cannot bypass the limits.
