-- Paid subject: Co so du lieu (DB101), 10000 VND.
-- Quiz bank served from paid-question-banks/db101/co_so_du_lieu.json.
insert into public.products (id, name, price_vnd, active)
values ('db101', 'Quiz và Đề ôn tập Cuối kỳ - Cơ sở dữ liệu (DB101)', 10000, true)
