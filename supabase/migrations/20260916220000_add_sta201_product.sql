-- Paid subject: Thong ke trong kinh doanh (STA201), 10000 VND.
-- Quiz bank + scanned final exams served from paid-question-banks/sta201/.
insert into public.products (id, name, price_vnd, active)
values ('sta201', 'Quiz ôn tập và Đề Cuối kỳ - Thống kê trong kinh doanh (STA201)', 10000, true)
on conflict (id) do update set name = excluded.name, price_vnd = excluded.price_vnd, active = excluded.active;

-- Paid quizzes must use verified server sessions, not client-reported free attempts.
...
begin
  ...
  if p_subject_id in (
    ...
    'data-science-ai-midterm-1',
    'data-science-ai-final-1',
    'data-science-ai-bank-1',
    'intro-data-science-ai-bank-1',
    'software-quality-assessment-final-bank-1',
    'sec-final-bank-2',
    'marketing-final-bank-1',
    'kinh-te-vi-mo-macro-bank-1',
    'office-it-final-bank-1',
    'finance-final-bank-1',
    'world-civilization-chapters-1-2-bank-1',
    'economics-bank-1',
    'phap-luat-dai-cuong-bank-1',
    'hcm-final-bank-1',
    'management-final-bank-1',
    'physics-1-final-docs-1',
    'ppt-midterm-docs-1',
    'ppt-final-docs-1',
    'calculus-final-docs-1',
    'dstt-final-docs-1',
    'xstk-midterm-docs-1',
    'philosophy-3-credit-final-bank-1',
    'political-economy-final-bank-1',
    'philosophy-2-credit-final-bank-1',
    'history-party-final-bank-1',
    'scientific-socialism-final-bank-1',
    'discrete-math-final-docs-1',
    'discrete-math-quiz-bank-1',
    'english-1-structure-docs-1',
    'english-1-final-bank-1',
    'research-methodology-final-bank-1',
    'nghien-cuu-khoa-hoc-trong-kinh-te-final-bank-1',
    'business-statistics-docs-1',
    'business-statistics-quiz-bank-1'
  ) then
