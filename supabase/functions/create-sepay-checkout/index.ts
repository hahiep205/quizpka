...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (rawProductId !== "dsai101" && rawProductId !== "idsai101" && rawProductId !== "sqa101" && rawProductId !== "sec301" && rawProductId !== "mar101" && rawProductId !== "mac102" && rawProductId !== "oit101" && rawProductId !== "fin101" && rawProductId !== "civ101" && rawProductId !== "eco101" && rawProductId !== "law101" && rawProductId !== "hcm101" && rawProductId !== "mgt101" && rawProductId !== "phy101" && rawProductId !== "ppt101" && rawProductId !== "ppt102" && rawProductId !== "gt101" && rawProductId !== "dst101" && rawProductId !== "xst101" && rawProductId !== "mln102" && rawProductId !== "pec101" && rawProductId !== "mln101" && rawProductId !== "his101" && rawProductId !== "soc101" && rawProductId !== "dm101") return Response.json({ error: "Product unavailable" }, { status: 400, headers: cors(req) })
    ...
    let orderId = pending?.order_id ?? `${productId === "sqa101" ? "SQA" : productId === "sec301" ? "SEC" : productId === "idsai101" ? "IDSAI" : productId === "mar101" ? "MAR" : productId === "mac102" ? "MAC" : productId === "oit101" ? "OIT" : productId === "fin101" ? "FIN" : productId === "civ101" ? "CIV" : productId === "eco101" ? "ECO" : productId === "law101" ? "LAW" : productId === "hcm101" ? "HCM" : productId === "mgt101" ? "MGT" : productId === "phy101" ? "PHY" : productId === "ppt101" || productId === "ppt102" ? "PPT" : productId === "gt101" ? "GT" : productId === "dst101" ? "DST" : productId === "xst101" ? "XST" : productId === "mln102" ? "MLN" : productId === "pec101" ? "PEC" : productId === "mln101" ? "ML1" : productId === "his101" ? "HIS" : productId === "soc101" ? "SOC" : productId === "dm101" ? "DM" : "DSAI"}-${crypto.randomUUID().replaceAll("-", "").slice(0, 20).toUpperCase()}`
