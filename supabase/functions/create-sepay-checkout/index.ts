...
Deno.serve(async (req) => {
  ...
  try {
    ...
    let orderId = pending?.order_id ?? `${productId === "sqa101" ? "SQA" : productId === "sec301" ? "SEC" : productId === "idsai101" ? "IDSAI" : productId === "mar101" ? "MAR" : productId === "mac102" ? "MAC" : productId === "oit101" ? "OIT" : productId === "fin101" ? "FIN" : productId === "civ101" ? "CIV" : productId === "eco101" ? "ECO" : productId === "law101" ? "LAW" : productId === "hcm101" ? "HCM" : productId === "mgt101" ? "MGT" : productId === "phy101" ? "PHY" : productId === "ppt101" || productId === "ppt102" ? "PPT" : productId === "gt101" ? "GT" : productId === "dst101" ? "DST" : productId === "xst101" ? "XST" : "DSAI"}-${crypto.randomUUID().replaceAll("-", "").slice(0, 20).toUpperCase()}`
