...
export const subjects: Subject[] = [
  ...
  },
  {
    ...
    chapters: [
      { id: "de1", label: { en: "Discrete Mathematics - Set 1", vi: "Đề Toán rời rạc Cuối kỳ - Tham khảo" }, documentId: "dm-de-1", solutionUrl: "https://www.youtube.com/watch?v=4qMwuFaWT7U", count: 3 },
      { id: "de2", label: { en: "Essay Exam 2", vi: "Đề tự luận 2 - Tham khảo" }, documentId: "dm-de-2", count: 2 },
      { id: "de3", label: { en: "Essay Exam 3", vi: "Đề tự luận 3 - Tham khảo" }, documentId: "dm-de-3", count: 2 },
      { id: "all", label: { en: "All chapters", vi: "Quiz ôn tập phần trắc nghiệm" }, count: 80 },
