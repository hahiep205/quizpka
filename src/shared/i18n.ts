...
export const dashboardCopy = {
  vi: {
    ...
    leaderboardDesc: "Xếp hạng theo 4 chỉ số học tập: môn đã ôn, lần luyện đề, độ chính xác và thời gian ôn tập.",
  ...
  en: {
    ...
    leaderboardDesc: "Ranked by the four learning stats: subjects reviewed, attempts, accuracy and study time.",
