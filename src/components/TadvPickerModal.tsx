              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-[15px] font-extrabold leading-5 text-[#100F3E] dark:text-white">{opt.title[lang]}</span>
                    <span className="mt-1 block text-[13px] font-semibold leading-4 text-slate-500 dark:text-slate-400">55 {t.questions}</span>
                  </span>
